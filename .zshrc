...
# - * File: .zshrc
# - * Author: itchyny
# - * Last Change: 2012/10/11 23:40:33.
# --------------------------------------------------------------------------------------------------------------
...
alias wget="wget --user-agent='Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_1) AppleWebKit/537.4 (KHTML, like Gecko) Chrome/22.0.1229.79 Safari/537.4' "
# git
