...
# - * File: .zshrc
# - * Author: itchyny
# - * Last Change: 2012/09/13 15:35:39.
# --------------------------------------------------------------------------------------------------------------
...
alias arxiv="wget --user-agent='Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_1) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/21.0.1180.89 Safari/537.1' "
# rlwrap
