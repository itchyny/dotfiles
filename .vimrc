...
" - * File: .vimrc
" - * Author: itchyny
" - * Last Change: 2014/01/27 18:14:37.
" --------------------------------------------------------------------------------------------------------
...
NeoBundle 'Shougo/unite.vim'
  ...
  let g:unite_source_file_mru_long_limit = 1
  let g:unite_source_directory_mru_limit = 1
  let g:unite_source_directory_mru_long_limit = 1
